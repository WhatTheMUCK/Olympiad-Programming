...
Рисунок описывается следующим образом: "(**image** parameters)". Каждый параметр рисунка имеет вид "имя=значение". Параметры рисунка разделены пробелами и/или переводом строки. У каждого рисунка обязательно есть следующие параметры:
...
<div align="center">
  <img src="../../.github/Яндекс_51J_Рисунок_1.PNG" alt="Рисунок 1">
</div>
...
<div align="center">
  <img src="../../.github/Яндекс_51J_Рисунок_2.PNG" alt="Рисунок 1">
</div>
